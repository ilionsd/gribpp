...
int main() {
	...
	using reader_func_t = decltype(mapping::make_section_map<mapping::grib_edition::V2, 0>);
	reader_func_t readerFuncPtr = mapping::make_section_map<mapping::grib_edition::V2, 0>;
